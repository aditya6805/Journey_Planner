...
export function SearchForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // In a real app, we would use react-router or window.location to navigate
    console.log({
      origin,
      destination,
      date,
    ...
    // Navigate to results page (will implement with React Router later)
    // window.location.href = `/results?origin=${origin}&destination=${destination}&date=${date}&mode=${travelMode}`;
  };
